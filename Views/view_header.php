...
<head>
  ...
  <link rel="stylesheet" href="css/<?= $_SESSION['view']?>.css">
  <link href="https://fonts.cdnfonts.com/css/rancho" rel="stylesheet">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
	<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  <link rel="shortcut icon" href="img/loup.png" style="width: 35px;">
...
<header class="main-head">
    ...
    <a href="?controller=connexion&action=home"><img src="img/loup.png" id="logo" alt="Mon titre"></a>
    ...
    <?php }?>
      <nav>
      <?php if ($_SESSION['grade'] === 1) {?>
        <a href="?controller=boutique&action=panier"><img src="img/cadie.png" class="uk" alt="drapeau royaume uni"></a>
        <div><button class="menubouton"><img src="img/parametre.svg" class="clientvert" alt="Logo Profil"></button>
